...
```{r}
k <- data.frame(num = c(1,2,3,4), letter = c("a", "b", "c", "d"), value = c(0.23, pi, 4.5, 999), condition = factor(c("A", "B", "A", "B")))
k
...
# the '#' character is reserved for comments, the code below will not execute due to an error above it in this chunk
a + b
```
