...
This is starting to look good, the whiskers show 95% CIs (mean $\pm 1.96$SEM), and all experimental conditions are shown. A little more work makes it publication ready.
...
*Continue to tutorial 3,* [Normality of residuals](https://github.com/ABindoff/R_tutorials/blob/master/3_Normality_of_residuals.md) 
